...
def test(data,
    ...
    if not training:
        ...
        val_path_rgb = data['val']
        #val_path_ir = data['val_ir']
        dataloader = create_dataloader(val_path_rgb, imgsz, batch_size, gs, opt, pad=0.5, rect=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/mjy/yolov5/runs/train/exp11/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='./data/multispectral/DroneVechile2.yaml', help='*.data path')
