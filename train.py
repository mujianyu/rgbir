...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='twoModelConcat.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='./data/multispectral/DroneVechile.yaml', help='data.yaml path')
