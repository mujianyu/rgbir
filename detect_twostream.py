...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/mjy/multispectral-object-detection/runs/train/exp68/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/home/mjy/multispectral-object-detection/datasets/IR/images/', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/home/mjy/multispectral-object-detection/datasets/RGB/images/', help='source')  # file/folder, 0 for webcam
